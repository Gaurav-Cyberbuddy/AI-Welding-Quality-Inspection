...
with torch.no_grad():
    ...
    for batch_number, (images, labels) in enumerate(
        ...
        # Probability of KO class (class 1)
...
print(f"True Negatives  (OK correctly predicted): {tn}")
print(f"False Positives (OK predicted as KO):      {fp}")
print(f"False Negatives (KO predicted as OK):      {fn}")
print(f"True Positives  (KO correctly predicted):  {tp}")
